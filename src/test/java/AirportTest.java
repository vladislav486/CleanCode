...
public class AirportTest {
    ...
    public void testGetTransportMilitaryPlanes() {
        ...
        for (MilitaryPlane militaryPlane : transportMilitaryPlanes) {
            if ((militaryPlane.getType() != MilitaryType.TRANSPORT)) {
                Assert.fail("The Method Is Not Getting Only Military Transport");
            }
        }
    }
    ...
    @Test
    public void testSortPlanesByLoadCapacity() {
        Airport airport = new Airport(planes);
        ...
        for (int i = 0; i < planesSortedByMaxLoadCapacity.size() - 1; i++) {
            ...
            if (currentPlane.getMaxLoadCapacity() > nextPlane.getMaxLoadCapacity()) {
                Assert.fail("Plains Are Not Sorted By Max Load Capacity!");
            }
        }
    }
    ...
    public void testExperimentalPlanesHaveClassificationLevelHigherThanUnclassified(){
        ...
        for(ExperimentalPlane experimentalPlane : experimentalPlanes){
            if(experimentalPlane.getClassificationLevel() == ClassificationLevel.UNCLASSIFIED){
              Assert.fail("Some Of Experimental Planes Have Unclassified Classification Level");
            }
        }
    }
}
